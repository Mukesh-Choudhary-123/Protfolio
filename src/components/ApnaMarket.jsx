...
const ApnaMarket = () => {
  return (
    <section className="bg-gray-100 dark:bg-[#1E1E1E]">
      <div className="container px-6 py-10 mx-auto">
        <h1 className="text-1xl font-semibold text-gray-800 capitalize lg:text-2xl dark:text-white">
          E-commerce 🛒 <br />
          <span className="text-[rgba(223,27,51,255)] text-2xl lg:text-3xl">
            Apna Market
          </span>
        </h1>
        {/* <iframe
